...
class ZebraAndroidPlugin: FlutterPlugin, MethodCallHandler {
  ...
  private fun startBarcodeScanning(){
    val startBarcodeIntent = Intent()
    startBarcodeIntent.action = Helpers.SEND_ACTION_COMMAND
    startBarcodeIntent.putExtra(Helpers.START_SCANNING, Helpers.START_BARCODE_SCANNING)
    context.sendBroadcast(startBarcodeIntent)
  }
